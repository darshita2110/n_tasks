                ...
                onPressed: () {
                  if(_nameController.text.isEmpty || _descController.text.isEmpty)
                   ...
                   DateFormat('dd-MM-yyyy').format(DateTime.now()).toString();
                    ...
                    print(" New event for backend developer ${json.encode(myEvents)}");

                  }
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromRGBO(
                      60, 160, 204, 0.6784313725490196),
                  padding: EdgeInsets.symmetric(horizontal: 40, vertical: 12),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                ),
                child: Text(
                  'Add',
                  style: TextStyle(fontSize: 30, fontFamily: 'Cookie', color: Colors.white),
                ),
              ),
            )
          ],
